...
{
    public class VanBanDenService : BaseService, IQuestionService
    {
        ...
        public VanBanDenService(HistoryQuestionService history, ILoggingService logger, IDbSettings settings,
            DataContext context,
