...
{
    public class LichCongTacService : BaseService, IQuestionService
    {
        ...
        public LichCongTacService(HistoryQuestionService history, ILoggingService logger, IDbSettings settings,
            DataContext context,
