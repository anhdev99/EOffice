...
import BanCognTacPhongBan from "./bancongtacphongban.vue";
import LichCongTacPhongBan from "./lichcongtacphongban";

export default {
  components: {Layout, PageHeader, BanCognTacPhongBan, LichCongTacPhongBan},
  data() {
    return {
