...
export default {
  ...
  data() {
    return {
      ...
      sortDesc: false,
      fields: [
        { key: 'STT', label: 'STT', class: 'td-stt', sortable: false,thClass: 'hidden-sortable',          thStyle: {width: '80px', minWidth: '50px'}, },
        {
          key: "tieuDe",
          label: "Tiêu đề",
...
<!--                          Lưu nháp-->
<!--                        </b-button>-->
                        <b-button type="button" @click="handleSubmit" variant="danger" size="sm" class="ms-1 w-md">
                          Gửi thư
                        </b-button>
        ...
        >
          ...
          <div>
            <div v-if="model.ngayNhanFull">Ngày gửi: {{model.ngayNhanFull}}</div>
            <div v-if="model.nguoiGui">
              -Người tạo {{model.nguoiGui.fullName}}
          ...
          <template #modal-header="{ close }">
            ...
            <h5> Thêm mới thư</h5>
            <div class="text-end">
              <b-button variant="light" class="w-md" size="sm" @click="showChiTietModal = false">
                Đóng
              </b-button>
            </div>
          </template>
